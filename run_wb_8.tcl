...
exec xvlog -sv -L uvm ../sim/sim_wb8/wb8_pkg.sv > xvlog_wb8_pkg.log 2>&1

# Compile interface and DUT files
exec xvlog -sv -L uvm ../sim/sim_wb8/top_interface.sv > xvlog_interfaces.log 2>&1
exec xvlog -sv -L uvm ../rtl/i2c_master_wbs_8.v >> xvlog_interfaces.log 2>&1

exec xvlog -sv -L uvm ../rtl/i2c_master.v ../rtl/i2c_master_wbs_8.v ../rtl/axis_fifo.v >> xvlog_interfaces.log 2>&1

# Compile testbench top
exec xvlog -sv -L uvm ../sim/sim_wb8/wb8_tb_top.sv > xvlog_tb_top.log 2>&1

# Elaborate
exec xelab -L uvm -timescale 1ns/1ps -debug typical wb8_tb_top -s wb8_tb_top > xelab.log 2>&1

# Run simulation
exec xsim -R wb8_tb_top -testplusarg "UVM_VERBOSITY=UVM_HIGH" > xsim.log 2>&1
